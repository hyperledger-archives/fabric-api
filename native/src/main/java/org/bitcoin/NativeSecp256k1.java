...
//        assertEquals(sigArr.length, sigLen, "Got bad signature length.");
    ...
    public static byte[] computePubkey(byte[] seckey) {
        Preconditions.checkArgument(seckey.length == 32);
...
//        assertEquals(pubArr.length, pubLen, "Got bad pubkey length.");
     ...
     */
    public static byte[] privKeyTweakMul(byte[] privkey, byte[] tweak) {
...
//        assertEquals(retVal, 1, "Failed return value check.");
     ...
     * @param tweak some bytes to tweak with
     */
    public static byte[] privKeyTweakAdd(byte[] privkey, byte[] tweak) {
        Preconditions.checkArgument(privkey.length == 32);
...
//        assertEquals(retVal, 1, "Failed return value check.");
     ...
     * @param pubkey 32-byte seckey
     */
    public static byte[] pubKeyTweakMul(byte[] pubkey, byte[] tweak) {
        Preconditions.checkArgument(pubkey.length == 33 || pubkey.length == 65);
...
//        assertEquals(retVal, 1, "Failed return value check.");
     ...
     */
    public static byte[] createECDHSecret(byte[] seckey, byte[] pubkey) {
...
//        assertEquals(retVal, 1, "Failed return value check.");
    ...
    public static byte[] schnorrSign(byte[] data, byte[] sec) {
        Preconditions.checkArgument(data.length == 32 && sec.length <= 32);
